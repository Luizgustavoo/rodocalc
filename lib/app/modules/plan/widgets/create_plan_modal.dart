        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Selecione uma forma de pagamento:"),
              const SizedBox(height: 10),
              Visibility(
                      ...
                      children: [
                        Expanded(
                          child: CustomElevatedButton(
                            gradient: controller.paymentMethod.value == 'PIX'
                        ...
                        Expanded(
                          child: CustomElevatedButton(
                            gradient: controller.paymentMethod.value == 'CARD'
                                ? const LinearGradient(colors: [
                                    Color.fromARGB(255, 11, 135, 5),
                                    Color.fromARGB(255, 40, 255, 108)
                                  ])
                      ...
                      children: [
                        ...
                        Obx(
                          () {
                            ...
                            int minLicencas =
                                controller.selectedPlan.value!.minLicencas!;
                            ...
                            List<DropdownMenuItem<int>> items = List.generate(
                              ...
                              (index) => DropdownMenuItem(
                                ...
                                child:
                                    Text('${minLicencas + index} Licença(s)'),
                              ),
                            );
                        ...
                        TextFormField(
                          ...
                          onChanged: (text) {
                            controller.nameCardController.value =
                              ...
                              selection:
                                  controller.nameCardController.selection,
                            );
                          },
                          validator: (value) {
                            if (value == null || value.isEmpty) {
